...
FDIC SDI REST API) and on a global G-SIB panel combining FDIC, World Bank,
and ECB data sources.
...
and G-SIB panel ($N{=}19$, $T{=}84$, $d{=}5$).  All data fetched
March 2026; latest quarter is 2025-Q4.
P75 threshold trained on pre-2007 data.}
\label{tab:live}
\begin{tabular}{lcc}
\toprule
Metric & U.S.\ Banks ($N{=}20$) & G-SIB ($N{=}19$) \\
\midrule
AUROC              & 0.577              & 0.696 \\
95\% CI            & [0.364, 0.807]     & [0.474, 0.896] \\
Hit Rate           & 82.6\%             & 100.0\% \\
False Alarm Rate   & 62.8\%             & 88.5\% \\
GFC Lead           & 71Q$^\dagger$      & 11Q \\
Spectral Radius    & 7.67               & --- \\
Peak CCyB          & 250 bps            & 250 bps \\
Granger (best $p$) & 0.452              & --- \\
\midrule
\multicolumn{3}{l}{\textbf{Current state (2025-Q4):}} \\
MFLS Signal        & 49.5               & 1346.0 \\
Alarm Threshold    & 24.0               & 26.5 \\
Above Threshold    & Yes                & Yes \\
Signal Z-score     & $+0.60\sigma$      & --- \\
CCyB               & 180 bps            & 250 bps \\
4Q Trend           & Falling ($-1.8\%$) & --- \\
Herding Score      & 0.42 (moderate)    & --- \\
\bottomrule
\multicolumn{3}{l}{\small $\dagger$ 71Q reflects persistent super-criticality:
the system has been above} \\
\multicolumn{3}{l}{\small \phantom{$\dagger$} the P75 threshold almost
...
The global panel ($N{=}19$ G-SIBs from 9 countries, $T{=}84$ quarters,
2005--2025) achieves AUROC = 0.696 with 100\% hit rate on the GFC window
and 11-quarter lead.  The extremely high current signal (1346) reflects
the wide diversity of national banking systems; the Mahalanobis distance
from the short calibration window (2005--2006) amplifies cross-country
heterogeneity.  The false alarm rate (88.5\%) confirms that the global
panel is better suited for regime identification than precise timing.
...
The institution-level panels ($N=20$ U.S.\ banks, $N=19$ G-SIBs) exclude
banks with $< 50\%$ data coverage, reducing the cross-section.  Goldman Sachs
(CERT 33124, data from 2008 onwards) and several regional banks are excluded.
A dynamic panel approach that handles entry/exit would increase coverage,
especially for post-2010 banks.

...
\paragraph{Aggregated institution types.}
The current analysis uses $N=7$ FDIC-classified institution types, not individual
banks.  With BIS Consolidated Banking Statistics at the institution level
($N \sim 30$ G-SIBs), the cross-sectional dimension increases by an order of
magnitude, potentially improving Granger causality power and providing
institution-level CCyB recommendations.

...
).sort("smurf_score", descending=True).head(1000).collect()
...
]).sort("fan_out_score", descending=True).head(1000).collect()
...
]).sort("fan_in_score", descending=True).head(1000).collect()
...
]).sort("layering_score", descending=True).head(1000).collect()
...
]).sort("structuring_score", descending=True).head(1000).collect()
...
]).sort("velocity_score", descending=True).head(1000).collect()
...
]).sort("peeling_score", descending=True).head(1000).collect()

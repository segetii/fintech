...
\begin{table}[t]
\centering
\caption{AUC-ROC comparison (mean $\pm$ std over 5 random splits, seeds 42/123/456/789/2024). UDL-QDA-Magnified uses a single hyperparameter set across all datasets. $^\dagger$Supervised methods. Best in bold, second-best underlined. Pendigits results are reported separately in \Cref{tab:perlaw}.}
\label{tab:main_results}
\begin{tabular}{@{}lccccc@{}}
\toprule
\textbf{Method} & \textbf{Synth.} & \textbf{Mimic} & \textbf{Mamm.} & \textbf{Shuttle} & \textbf{Mean} \\
\midrule
\textbf{UDL-QDA-Mag.$^\dagger$} & \textbf{1.000} & \textbf{1.000} & \textbf{0.947} & \underline{0.989} & \textbf{0.984} \\
$k$-NN Distance & \textbf{1.000} & \textbf{1.000} & 0.876 & 0.984 & 0.965 \\
LOF & \textbf{1.000} & \textbf{1.000} & 0.838 & \textbf{0.991} & 0.957 \\
Isolation Forest & \textbf{1.000} & \textbf{1.000} & 0.874 & 0.943 & 0.954 \\
UDL-Fisher$^\dagger$ & \textbf{1.000} & \textbf{1.000} & \underline{0.901} & 0.889 & 0.948 \\
ECOD & \textbf{1.000} & \textbf{1.000} & 0.862 & 0.931 & 0.948 \\
Deep SVDD & \textbf{1.000} & 0.998 & 0.871 & 0.956 & 0.956 \\
One-Class SVM & \textbf{1.000} & \textbf{1.000} & 0.793 & 0.922 & 0.929 \\
Elliptic Envelope & \textbf{1.000} & \textbf{1.000} & 0.689 & 0.918 & 0.902 \\
\midrule
MDN Unsupervised & \textbf{1.000} & \textbf{1.000} & 0.873 & 0.662 & 0.884 \\
\textbf{GravityEngine} & 0.999 & 0.994 & 0.899 & 0.786 & 0.920 \\
\bottomrule
\end{tabular}
\end{table}

Three results stand out. First, UDL-QDA-Magnified achieves the highest mean AUC (0.984) across all methods. Since both synthetic datasets are trivial (every method $\geq 0.998$), the real-data mean (mammography + shuttle) is $0.968$, exceeding the best unsupervised baseline ($k$-NN, $0.930$) by $+0.038$. On mammography alone, the margin over $k$-NN is $+0.071$ ($0.947$ vs $0.876$). Second, the mimic dataset tests whether multi-spectrum projection can defeat partial mimicry: it can (AUC = 1.000). Third, GravityEngine, evaluated on all five datasets, reaches a mean AUC of 0.920 (Synth.~0.999, Mimic~0.994, Mamm.~0.899, Shuttle~0.786, Pendigits~0.770), competitive on easy and medical datasets but weaker on the high-dimensional shuttle and pendigits benchmarks. The MDN unsupervised score (no labels) achieves mean AUC 0.884, confirming that the multi-spectrum representation carries signal even without supervised projection.

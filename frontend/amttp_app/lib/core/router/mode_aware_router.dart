...
// Feature pages
// Dead imports removed: home_page.dart, focus_home_page.dart (only FintechHomePage from premium_fintech_shell.dart is used)
...
// Dead import removed: light_home_page.dart (only FintechHomePage from premium_fintech_shell.dart is used)
      ...
      if (isAuthenticated) {
        ...
        if (isWarRoomRoute) {
          ...
          if (isComplianceRoute &&
              !rbacState.role.isAtLeast(Role.r4InstitutionCompliance)) {
            return '/war-room';
          }

          // Admin routes require R5+
          final isAdminRoute =
              location.contains('/users') || location.contains('/system');
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (context, state) {
              ...
              return PremiumTrustCheckPage(
                  initialAddress: address.isEmpty ? null : address);
            },
          ),
